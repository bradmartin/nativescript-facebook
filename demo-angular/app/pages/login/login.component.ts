...
export class LoginComponent {
	...
	init() {
		...
		this.canShowLinksShareDialog = Facebook.canShareDialogShow(
			this.linkContent
		);
		this.canShowPhotosShareDialog = Facebook.canShareDialogShow(
			this.photosContent
		);
		this.canShowLinksMessageDialog = Facebook.canMessageDialogShow(
			this.linkContent
		);
		this.canShowGenericMessageDialog = Facebook.canMessageDialogShow(
			this.genericContent
		);
	}
	...
	generateLinksShareContent() {
		return Facebook.createShareLinksContent(
	...
	generateGenericTemplateContent() {
		return Facebook.createShareMessageGenericTemplateContent({
			...
			pageID: 'testestsett',
			imageAspectRatio:
				Facebook.MessageGenericTemplateImageAspectRatio.Horizontal
		});
	}
