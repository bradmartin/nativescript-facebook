 ...
 */
export declare function createShareLinksContent(
	link: string,
	quote?: string,
 ...
 * @param {ShareAdditionContent} addition When you use the Facebook share dialog, you have additional options that aren't available when you share by using the API.
 */
export declare function createSharePhotosContent(
 ...
 */
export declare function createShareMessageGenericTemplateContent(
 ...
 */
export declare function createShareMessageMediaTemplateContent(
 ...
 */
export declare function showShareDialog(
	content: any,
 ...
 * @param {ShareCallbackFunction} callback: Callback for the sharing dialog
 */
export declare function showMessageDialog(
	content: any,
	callback?: ShareCallbackFunction
): void;
